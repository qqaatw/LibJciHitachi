...
API_SSL_CONTEXT.set_ciphers("TLSv1.2")  # the cert uses SHA1-RSA1024bits ciphers so unfortunately we have to lower the security level
API_SSL_CONTEXT.hostname_checks_common_name=True  # the cert lack a subjectaltname
